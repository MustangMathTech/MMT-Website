<script>
    ...
    export let button_icon = "";
    export let use_image_arrow = false;
    ...
    {#if visible}
        <div in:fly="{{ y: -20, duration: 700 }}" class="minidiv">
            ...
            <div class="flex" style="margin-top: 15px;">
                {#if use_image_arrow}
                    <a href={button_url} class="headerButton" target={target} rel="noopener noreferrer">
                        <div class="headerButton" style="cursor: pointer;">
                            <p class="headerButton" id={button_id}>{button_text}</p>
                            <img
                                class="headerButtonArrow"
                                src="/right-arrow.png"
