...
<div style="margin-left: 10vw; margin-right: 10vw;">
    <PanelBox>
        ...
        We offer tutoring in a variety of math subjects: ranging from help with school material (Algebra 1 to Calculus) to competition training (AMC 8 and Mathcounts to AIME). If you're interested in our services, please sign up using the <a href="https://forms.gle/D1ckzySxmH5L7v4X9">form</a>! The price is $30/hour, of which $10 is fully reinvested into Mustang Math and $20 is paid to the instructor. Upon expressing interest, we will match you with a student who is specifically experienced and highly comfortable with the material that you need help with.<br /><br />
