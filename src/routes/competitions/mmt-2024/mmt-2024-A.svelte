...
<svelte:head>
    <title>MMT 2024 {data["State"]}</title>
</svelte:head>
...
<div class="schedule-wrapper">
    <FlexBox>
        <PanelBox>
            <Table data={sD} width="auto" headerColor="#1B9AAA" rowColors={["#A4D6AF", "#ADCDD6"]} cellPadding={5} cellPaddingRight={20} tableStyle="margin-left: auto; margin-right: auto"/>
